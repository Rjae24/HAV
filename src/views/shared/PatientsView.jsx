            ...
            {loading ? (
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-3 p-3 rounded-xl text-left transition-all ${isSelected ? 'bg-hav-primary/10 border-hav-primary/30 shadow-sm' : 'hover:bg-gray-50 border-transparent'
                    } border`}
                >
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm flex-shrink-0 ${isSelected ? 'bg-hav-primary text-white' : 'bg-gray-100 text-hav-text-main'
                    }`}>
                    {p.nombre[0]}
                  </div>
